...
namespace CashMap
{
    public partial class Revenus : Form
    {
        ...
        private void transactionsBindingNavigatorSaveItem_Click(object sender, EventArgs e)
        {
            ...
            this.tableAdapterManager.UpdateAll(this.cashMapDataSet);
        ...
        private void LoadDataIntoGridView()
        {
            ...
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    string query = "SELECT id_transaction, montant, date_transaction, description FROM Transactions WHERE type = 'revenu';";
        ...
        private void ajouterB_Click(object sender, EventArgs e)
        {
            ...
            string type = "revenu"; // Since the type is fixed as "depense"
